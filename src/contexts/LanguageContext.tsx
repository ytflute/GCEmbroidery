...
const translations = {
  zh: {
    ...
    // About
    'about.title': '廣承綉花實業社',
    'about.subtitle': '創立於1989年，台南在地電腦刺繡量產加工廠',
    ...
    'portfolio.project2.title': '設計打版刺繡產品一條龍',
    'portfolio.project2.description': '各式刺繡圖案設計、打版、訂製，吊飾、布章等刺繡產品，色彩鮮豔、立體飽滿。',
    'portfolio.project3.title': '西裝電腦刺繡',
    'portfolio.project3.description': '客訂西裝刺繡加工，線條細緻、質感優異。',
    'portfolio.project4.title': '刺繡布料加工',
    'portfolio.project4.description': '布料刺繡訂製，量產加工，精準定位、針腳工整，複雜圖案多色刺繡製作，色彩層次豐富、圖案細節完整，展現專業刺繡工藝。可應用於繡花鞋布品、服飾布品、內衣褲布品等。',
